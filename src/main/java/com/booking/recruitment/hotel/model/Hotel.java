...
public class Hotel implements Serializable {
  ...
  public void setDistance(double distance) {
    this.distance = Haversive.distance(city.getCityCentreLatitude(), city.getCityCentreLongitude(), latitude, longitude);
  }
  ...
  public static class Builder {
    ...
    public Hotel build() {
      return new Hotel(id, name, rating, city, address, latitude, longitude, deleted, distance);
    }
  }
}
